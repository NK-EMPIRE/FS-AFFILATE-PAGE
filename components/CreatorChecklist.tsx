      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 pb-5 border-b border-white/[0.06]">
        <div>
          <div className="flex items-center gap-2 mb-1.5">
            ...
            <span className="text-xs font-mono uppercase tracking-widest text-[#FF8533] font-bold">
              FirstSelfie Production Blueprint
            </span>
          </div>
          <h3 className="font-hero text-xl sm:text-2xl font-black text-white tracking-tight">
            Essential Creator Studio Checklist
          </h3>
          <p className="mt-1 text-xs text-zinc-400">
            Click any item to verify your gear setup before shooting.
          </p>
        </div>

        <div className="flex items-center gap-3">
          <div className="rounded-2xl border border-white/[0.08] bg-white/[0.03] px-4 py-2 text-right">
            <div className="text-[10px] font-mono uppercase tracking-wider text-zinc-400">Ready Status</div>
            <div className="text-sm font-bold font-mono text-[#FF9A3C]">
        ...
        {items.map(item => (
          <button
            ...
            className={`group flex items-start justify-between gap-3 text-left rounded-2xl border p-4 transition-all duration-200 ${
              item.checked
                ? 'border-[#FF6B00]/30 bg-[#FF6B00]/[0.04] hover:border-[#FF6B00]/60'
          ...
          >
            <div className="flex items-start gap-3 overflow-hidden">
              ...
              <div className="min-w-0">
                <div className="text-xs font-bold text-white group-hover:text-[#FF8533] transition-colors">
                  {item.label}
                </div>
            ...
            <span className="shrink-0 text-[10px] font-mono font-semibold text-zinc-500 rounded-md bg-white/[0.04] px-1.5 py-0.5">
              ×{item.count}
            </span>
          </button>
        ))}
